...
版本日期：2026-03-18
適用路徑：H:\AI\Django（並作為其他專案主規範來源）

## 規範層級
1. 本檔（H:\AI\Django\rules.md）為五專案最高規範。
...
## 共用開發設定
- 共用開發 workspace：H:\AI\DJANGO\openclaw-workspace
...
- 請將長期有效政策同步記錄於：
  H:\AI\DJANGO\openclaw-workspace\LONG_TERM_MEMORY.md
