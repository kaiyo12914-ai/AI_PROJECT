...
|---|---|---|---|---|---|---|
| ALLOWED_HOSTS | N | (not explicitly fixed in code; environment-dependent) | Reverse proxy/network routing | webproj/settings.py; webapps/portal/middleware*.py | http://127.0.0.1:8000 or .//... | Medium |
| API_CONTEXT_PATH | N | (not explicitly fixed in code; environment-dependent) | Application setting | webapps/rag_oracle/*; webapps/meetingreply/views.py | http://127.0.0.1:8000 or .//... | Low |
| CHROMA_DIR | N | (not explicitly fixed in code; environment-dependent) | RAG/vector store configuration | webapps/rag_oracle/*; webapps/meetingreply/views.py | http://127.0.0.1:8000 or .//... | Low |
| CHROMA_PERSIST_DIR | N | (not explicitly fixed in code; environment-dependent) | RAG/vector store configuration | webapps/rag_oracle/*; webapps/meetingreply/views.py | http://127.0.0.1:8000 or .//... | Low |
| CSRF_COOKIE_PATH | N | (not explicitly fixed in code; environment-dependent) | Cookie/CSRF security settings | webproj/settings.py; webapps/portal/middleware*.py | http://127.0.0.1:8000 or .//... | Medium |
...
| DB_FACTORY_MD_PATH | N | (not explicitly fixed in code; environment-dependent) | Application setting | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Low |
...
| ENV_PATH | N | (not explicitly fixed in code; environment-dependent) | Application setting | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Low |
...
| MODEL_BASE_URL | N | (not explicitly fixed in code; environment-dependent) | LLM model/provider configuration | webapps/llm/llm_factory.py; webapps/llm/services.py | http://127.0.0.1:8000 or .//... | Low |
...
| OLLAMA_BASE_URL | N | (not explicitly fixed in code; environment-dependent) | LLM model/provider configuration | webapps/llm/llm_factory.py; webapps/llm/services.py | http://127.0.0.1:8000 or .//... | Low |
| OLLAMA_BASE_URL_EXTERNAL | N | (not explicitly fixed in code; environment-dependent) | LLM model/provider configuration | webapps/llm/llm_factory.py; webapps/llm/services.py | http://127.0.0.1:8000 or .//... | Low |
...
| OPENAI_BASE_URL | N | https://api.openai.com | LLM model/provider configuration | webapps/llm/llm_factory.py; webapps/llm/services.py | http://127.0.0.1:8000 or .//... | Low |
...
| ORA_HOST | N | (not explicitly fixed in code; environment-dependent) | Oracle/ACL configuration | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Medium |
...
| RAG_CHROMA_DIR | N | (not explicitly fixed in code; environment-dependent) | RAG/vector store configuration | webapps/rag_oracle/*; webapps/meetingreply/views.py | http://127.0.0.1:8000 or .//... | Low |
...
| SESSION_COOKIE_PATH | N | (not explicitly fixed in code; environment-dependent) | Cookie/CSRF security settings | webproj/settings.py; webapps/portal/middleware*.py | http://127.0.0.1:8000 or .//... | Medium |
...
| SQLDOC_JSON_PATH | N | (not explicitly fixed in code; environment-dependent) | Application setting | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Low |
...
| SQLTEST_JSON_PATH | N | (not explicitly fixed in code; environment-dependent) | Application setting | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Low |
...
| SQL_SERVER_HOST | N | (not explicitly fixed in code; environment-dependent) | SQL Server configuration | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Medium |
...
| SYBASE_HOST | N | (not explicitly fixed in code; environment-dependent) | Sybase configuration | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Medium |
| SYBASE_INI_PATH | N | (not explicitly fixed in code; environment-dependent) | Sybase configuration | webapps/database/db_factory.py; webapps/doc/services/doc_db_router.py | http://127.0.0.1:8000 or .//... | Low |
...
| TTS_API_BASE_URL | N | (not explicitly fixed in code; environment-dependent) | Application setting | Cross-module usage | http://127.0.0.1:8000 or .//... | Low |
