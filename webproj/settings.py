...
# NL2SQL / Vanna 2.0
NL2SQL_EMBEDDING_PROVIDER = env_str("NL2SQL_EMBEDDING_PROVIDER", "OLLAMA").upper()
NL2SQL_EMBEDDING_MODEL = env_str("NL2SQL_EMBEDDING_MODEL", "snowflake-arctic-embed2")
NL2SQL_OLLAMA_EMBEDDING_MODEL = env_str(
    "NL2SQL_OLLAMA_EMBEDDING_MODEL",
    NL2SQL_EMBEDDING_MODEL or "snowflake-arctic-embed2",
)
...
NL2SQL_EMBEDDING_DIMENSION = env_int("NL2SQL_EMBEDDING_DIMENSION", 1024)
