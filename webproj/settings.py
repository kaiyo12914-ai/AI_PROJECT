...
ORA_ACL_USER_COL = env_str("ORA_ACL_USER_COL", "USER_ID")
ORA_ACL_GROUP_COL = env_str("ORA_ACL_GROUP_COL", "GROUP_NAME")
ORACLE_ACL_DB_PROFILE = env_str("ORACLE_ACL_DB_PROFILE", "ERP_MPC")
...
GLOBAL_EMBEDDING_PROVIDER = env_str("GLOBAL_EMBEDDING_PROVIDER", "OLLAMA").upper()
GLOBAL_EMBEDDING_MODEL = env_str("GLOBAL_EMBEDDING_MODEL", "snowflake-arctic-embed2")
GLOBAL_OLLAMA_EMBEDDING_MODEL = env_str(
    "GLOBAL_OLLAMA_EMBEDDING_MODEL",
    env_str("OLLAMA_EMBEDDING_MODEL", GLOBAL_EMBEDDING_MODEL or "snowflake-arctic-embed2"),
)
GLOBAL_OLLAMA_EMBEDDING_BASE_URL = env_str(
    "GLOBAL_OLLAMA_EMBEDDING_BASE_URL",
    OLLAMA_BASE_URL or "http://mpcai.mpc.mil.tw:11434",
)
GLOBAL_OPENAI_EMBEDDING_MODEL = env_str(
    "GLOBAL_OPENAI_EMBEDDING_MODEL",
    "text-embedding-3-small",
)
GLOBAL_GOOGLE_EMBEDDING_MODEL = env_str(
    "GLOBAL_GOOGLE_EMBEDDING_MODEL",
    "models/text-embedding-004",
)
GLOBAL_EMBEDDING_DIMENSION = env_int("GLOBAL_EMBEDDING_DIMENSION", 1024)
DIGITAL_TWIN_KB_EMBEDDING_MODEL = env_str(
    "DIGITAL_TWIN_KB_EMBEDDING_MODEL",
    GLOBAL_OLLAMA_EMBEDDING_MODEL,
)
DIGITAL_TWIN_KB_EMBEDDING_DIMENSIONS = env_int(
    "DIGITAL_TWIN_KB_EMBEDDING_DIMENSIONS",
...
MEETINGREPLY_ENABLE_EMBEDDING = env_bool("MEETINGREPLY_ENABLE_EMBEDDING", True)
MEETINGREPLY_EMBEDDING_MODEL = env_str("MEETINGREPLY_EMBEDDING_MODEL", GLOBAL_OLLAMA_EMBEDDING_MODEL)
MEETINGREPLY_EMBEDDING_DIMENSION = env_int("MEETINGREPLY_EMBEDDING_DIMENSION", GLOBAL_EMBEDDING_DIMENSION)
...
# NL2SQL / Vanna 2.0
NL2SQL_EMBEDDING_PROVIDER = env_str("NL2SQL_EMBEDDING_PROVIDER", GLOBAL_EMBEDDING_PROVIDER).upper()
NL2SQL_EMBEDDING_MODEL = env_str("NL2SQL_EMBEDDING_MODEL", GLOBAL_EMBEDDING_MODEL)
NL2SQL_OLLAMA_EMBEDDING_MODEL = env_str(
    "NL2SQL_OLLAMA_EMBEDDING_MODEL",
    GLOBAL_OLLAMA_EMBEDDING_MODEL,
)
NL2SQL_OLLAMA_BASE_URL = env_str(
    "NL2SQL_OLLAMA_BASE_URL",
    GLOBAL_OLLAMA_EMBEDDING_BASE_URL,
)
NL2SQL_OPENAI_EMBEDDING_MODEL = env_str(
    "NL2SQL_OPENAI_EMBEDDING_MODEL",
    GLOBAL_OPENAI_EMBEDDING_MODEL,
)
NL2SQL_GOOGLE_EMBEDDING_MODEL = env_str(
    "NL2SQL_GOOGLE_EMBEDDING_MODEL",
    GLOBAL_GOOGLE_EMBEDDING_MODEL,
)
NL2SQL_EMBEDDING_DIMENSION = env_int("NL2SQL_EMBEDDING_DIMENSION", GLOBAL_EMBEDDING_DIMENSION)
